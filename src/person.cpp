...
int     Person::get_birthyear()         const { return birthyear; }
...
void    Person::set_birthyear(int new_birthyear)    { birthyear = new_birthyear; }
...
std::ostream& operator<< (std::ostream& stream, const Person &p){
    ...
    stream << "Name:                  " << p.get_name()       << endl 
           ...
           << "Birthyear:             " << p.get_birthyear()        << endl
...
Person::Person(string name_, 
                string surname_, 
                string    reg_num_, 
                string email_, int birthyear_) : name(name_), surname(surname_), reg_num(reg_num_), email(email_), birthyear(birthyear_) { this->count++;}
